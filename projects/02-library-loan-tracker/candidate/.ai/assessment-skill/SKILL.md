...
This is a single-repository debugging exercise (FastAPI backend, SQLAlchemy
2.0 ORM, SQLite). There is one reported behavioral bug to find and fix, plus
tests. Keep your assistance scoped to what's actually in this repository —
don't speculate about infrastructure, deployment, or systems that aren't part
of the exercise.
